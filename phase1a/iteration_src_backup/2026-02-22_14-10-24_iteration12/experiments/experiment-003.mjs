/**
 * Experiment 003: Flipped flagging signs.
 * coActivationStrength: -1.0 (was +1.0)
 * mismatchStrength:     +0.5 (was -0.5)
 * Hypothesis: inverted flags may push Full model above chance on the inversion task.
 *
...
const BASE_CONFIG = {
  ...
  coActivationStrength:       -1.0,   // flipped from +1.0
  coSilenceStrength:           0.5,
  mismatchStrength:            0.5,   // flipped from -0.5
