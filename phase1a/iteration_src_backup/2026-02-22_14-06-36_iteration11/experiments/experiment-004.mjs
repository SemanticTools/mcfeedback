/**
 * Experiment 004: Flag strengthen / decay mechanism.
 * Flags must be pushed consistently for N turns before they contribute to learning.
 * coActivationStrength: +1.0 (restored from experiment-003)
 * mismatchStrength:     -0.5 (restored from experiment-003)
 * flagStrengthGain:      0.3  — each consistent turn adds 0.3 to flagStrength
 * flagDecayRate:         0.7  — flagStrength * 0.7 per turn when trace is zero
 * flagStrengthThreshold: 0.5  — minimum |flagStrength| to gate weight update
 * Net effect: ~2 consistent turns unlock a synapse for learning.
 *
 * Same 10-seed setup as multi-seed.mjs for direct comparison.
 */
