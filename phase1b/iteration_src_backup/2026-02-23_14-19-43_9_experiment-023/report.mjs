// Experiment 023 report generator — Markdown + HTML
...
export function generateReport(allResults, config, startTime) {
  ...
  writeFileSync('./reports/experiment-023.md',   buildMarkdown(allResults, config, stats, duration));
  writeFileSync('./reports/experiment-023.html',  buildHtml(allResults, config, stats, duration));

  console.log('\nReports written to ./reports/experiment-023.md and ./reports/experiment-023.html');
}
...
function buildMarkdown(allResults, config, stats, duration) {
  ...
  return `# Experiment 023 — Epsilon-Exploration Astrocytes
...
<head>
<meta charset="UTF-8">
<title>Experiment 023 — Epsilon-Exploration Astrocytes</title>
<style>
...
<body>
<h1>Experiment 023 — Epsilon-Exploration Astrocytes</h1>
